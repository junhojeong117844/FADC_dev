...
// Usgage :  ROOT> .L nkfadc500_4_test.C
...
int run(int Nevent = 100000, const char* filename = "filename.dat") {
  ...
  unsigned long cw = 73;	 	// coincidence width (8 ~ 32760)
  ...
  unsigned long pwt = 200;		// pulse width threshold (2 ~ 1022 ns)
  ...
  unsigned long en_ptrig = 0; 		 // when 1 enables pedestal trigger
  unsigned long en_rtrig = 0; 	         // when 1 enables software trigger
  unsigned long en_etrig = 0;            // when 1 enables external trigger
